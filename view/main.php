                ...
                for($i = 0; $i< count($arac_listesi);$i++){
                    ...
                    if($arac_listesi[$i]['rezerve'] != 0){
                        ...
                        <div class="card-body">
                            ...
                            <a href="aracSayfasi.php?aracId='.$arac_listesi[$i]['id'].'" class="btn btn-success mt-4">Kirala</a>
                        </div>
                        </div>
                    ';
                        ...
                        <div class="card-body">
                            ...
                            <a href="aracSayfasi.php?aracId='.$arac_listesi[$i]['id'].'" class="btn btn-success">Kirala</a>
                        </div>
                        </div>
                    ';
                    }
